...
<Text style={styles.loginText}>Login</Text>
 <TextInput mode='outlined'placeholder='Government id' outlineColor='#e0e7e5' activeOutlineColor={Colors.bgDark} textColor='black' outlineStyle={styles.outline} style={styles.input} value={userInfo.Gov_id_of_Daily_Wages}
 onChangeText={(text) => handleInputChange('Gov_id_of_Daily_Wages', text)}
 />
